...
export class AddUserAndMessageTables1690205154087
  implements MigrationInterface
{
  name = 'AddUserAndMessageTables1690205154087';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "message" ("id" SERIAL NOT NULL, "post" text NOT NULL, "userId" integer, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
